...
set_clock_groups -asynchronous -group {clk50 *pll1|clk[*]} -group {lvdsin_clk clk_ext *pll1|clk[*]~1} -group {ftdi_clk} -group {scanclk} -group {spireset}
